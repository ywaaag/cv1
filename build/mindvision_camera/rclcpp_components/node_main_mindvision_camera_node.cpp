...
#define NODE_MAIN_LOGGER_NAME "mindvision_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmindvision_camera.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mindvision_camera::MVCameraNode>";
